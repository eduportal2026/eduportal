...
export default async function CourseAttendancePage({ params }: { params: { courseId: string } }) {
  ...
  return (
    <div>
      <div style={{ marginBottom: '2rem' }}>
        <a href="/dashboard/attendance" style={{ color: 'var(--primary)', textDecoration: 'none', marginBottom: '1rem', display: 'inline-block' }}>&larr; ย้อนกลับ</a>
